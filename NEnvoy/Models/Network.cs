...
(
    ...
    [property: JsonPropertyName("last_enlighten_report_time")][property: JsonConverter(typeof(TimestampDateTimeOffsetJsonConverter))] DateTimeOffset LastEnlightenReportTime,
